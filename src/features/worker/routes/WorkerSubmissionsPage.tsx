...
export function WorkerSubmissionsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid min-w-0 gap-6 lg:grid-cols-[1.12fr_0.88fr]">
        <div className="min-w-0 rounded-[1.8rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          {selectedTask && selectedClaim ? (
            <div className="space-y-5">
              <div className="grid min-w-0 gap-4 xl:grid-cols-[1.04fr_0.96fr]">
                ...
                <div className="min-w-0 rounded-[1.5rem] border border-slate-200 bg-slate-950 p-5 text-white">
          ...
          <div className="space-y-3">
            {workerClaims.map((claim) => {
              ...
              return (
                ...
                >
                  <div className={`min-w-0 font-medium ${isSelected ? "text-white" : "text-slate-950"}`}>{task?.title ?? "Task"}</div>
