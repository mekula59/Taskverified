...
export function HomePage() {
  return (
    <div className="space-y-4">
          ...
          <div className="px-6 py-7 md:px-9 md:py-8 lg:py-9">
            <div className="max-w-3xl">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Button asChild variant="outline" className="h-11 rounded-full border-white/18 bg-transparent px-5 text-white hover:bg-white/10 hover:text-white">
            ...
            <div className="rounded-[1.25rem] bg-white p-4 text-slate-950 shadow-[0_24px_70px_-52px_rgba(0,0,0,0.8)]">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-2 text-xl font-semibold tracking-tight">{featuredTask?.title ?? "Task proof review"}</h2>
                </div>
      ...
      {featuredTask ? (
        <section className="grid gap-5 rounded-[1.5rem] bg-white p-5 shadow-sm ring-1 ring-slate-200 md:p-7 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Public task preview</p>
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-slate-950">A task should show the standard before the claim.</h2>
            ...
            <Button asChild variant="outline" className="mt-5 h-10 rounded-full border-slate-300 bg-white">
              <Link to="/tasks">
